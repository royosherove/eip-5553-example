...
### Examples (TBD - ignore anything below this)

This standard being used on an ERC-721 during deployment:

#### Minting a work from a registery, where the work is based on IWorksRegistration and attaching related tokens

```solidity
//Registry code
 function mintSong(SongMintingParams memory _params) public onlyOwner {
        CompositionRoyaltyToken comp = // ERC20 Token
        RecordingRoyaltyToken rec =  // ERC20 Token
